...
var motorcycle_route_exports = {};
__export(motorcycle_route_exports, {
  default: () => motorcycle_route_default
});
module.exports = __toCommonJS(motorcycle_route_exports);
...
route.post("/motorcycles", (req, res, nest) => new Motorcycle_controller_default(req, res, nest).create());
route.get("/motorcycles", (req, res, nest) => new Motorcycle_controller_default(req, res, nest).find());
route.get("/motorcycles/:id", (req, res, nest) => new Motorcycle_controller_default(req, res, nest).findById());
route.put("/motorcycles/:id", (req, res, nest) => new Motorcycle_controller_default(req, res, nest).updatedMotorcycle());
var motorcycle_route_default = route;
